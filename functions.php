...
function twentyten_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<?php if ( $comment->comment_approved == '0' ) : ?>
			<strong><?php _e( 'Your comment is awaiting moderation.', 'twentyten' ); ?></strong>
			<br />
		<?php endif; ?>
...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Primary Blog Widget Area', 'twentyten' ),
	...
	register_sidebar( array(
		'name' => __( 'Secondary Blog Widget Area', 'twentyten' ),
	...
	// Area 3, located below the Secondary Widget Area in the sidebar. Empty by default.
	register_sidebar( array(
		'name' => __( 'Third Blog Widget Area', 'twentyten' ),
	...
	// Area 4, located below the Secondary Widget Area in the sidebar. Empty by default.
	register_sidebar( array(
		'name' => __( 'Fourth Blog Widget Area', 'twentyten' ),
	...
	// Area 5, located on all subpages. Empty by default.
	register_sidebar( array(
		'name' => __( 'Subpage Widgets', 'twentyten' ),
		'id' => 'subpage-widget-area',
		'description' => __( 'The primary subpage widget area', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	// Area 6, located on all subpages. Empty by default.
	register_sidebar( array(
		'name' => __( 'Secondary Subpage Widgets', 'twentyten' ),
		'id' => 'secondary-subpage-widget-area',
		'description' => __( 'The secondary subpage widget area', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
if ( !function_exists('fb_addgravatar') ) {
	function fb_addgravatar( $avatar_defaults ) {
		...
		$avatar_defaults[$myavatar] = 'e-Teacher';
